from .experiment_functions import recursive_stratified
...
if __name__ == '__main__':
    ...
    {"Rep_num": 200, "nodes_per_layer": [4, 10, 10, 10, 10, 5, 5], "seed": 1},
    {"Rep_num": 200, "nodes_per_layer": [4, 10, 10, 10, 10, 5, 5, 5], "seed": 1},
    {"Rep_num": 200, "nodes_per_layer": [4, 10, 10, 10, 10, 5, 5, 5, 5], "seed": 1},
    {"Rep_num": 200, "nodes_per_layer": [4, 10, 10, 10, 10, 5, 5, 5, 5, 5], "seed": 1},
    {"Rep_num": 200, "nodes_per_layer": [4, 10, 10, 10, 10, 5, 5, 5, 5, 5, 5], "seed": 1}
    ]
